...
V2RAY_SUBSCRIPTION_TEMPLATE = config("V2RAY_SUBSCRIPTION_TEMPLATE", default="V2ray/block.json")
V2RAY_SETTINGS_TEMPLATE_BL = config("V2RAY_SETTINGS_TEMPLATE", default="v2ray/settings.json")
